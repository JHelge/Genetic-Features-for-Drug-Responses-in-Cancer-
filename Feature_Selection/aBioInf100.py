...
def main():
	...
	totalRuns=10
	print(sys.argv[1])
	if os.path.isdir("../Drug"+str(sys.argv[1])+"_analysis"):
		Parallel(n_jobs=threads, verbose=5, backend="multiprocessing")(delayed(mainRun)(sys.argv[1], i) for i in range(0,totalRuns))
	return
