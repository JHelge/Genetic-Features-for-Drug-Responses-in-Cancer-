...
def loadDataset(drugIndex) :
	...
	print (dfData.to_numpy(), dfLabels.to_numpy().ravel().astype(int))
	return dfData.to_numpy(), dfLabels.to_numpy().ravel().astype(int) # to have it in the format that the classifiers like
