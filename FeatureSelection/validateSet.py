...
def loadDataset(drugIndex,features_to_analyze_path) :
	...
	# create folder
	folderName =dataDirectory+"/possiblyImportant/"
...
def runFeatureReduce(drugIndex,features_to_analyze_path) :
	...
	for originalClassifier, classifierName in classifierList :
		...
		print(line)
		fo = open(dataDirectory+"/possiblyImportant/results.txt", 'a')
		fo.write( line )
		fo.close()
		rmseo = open(dataDirectory+"/possiblyImportant/rmseresults.txt", 'a')
...
if __name__ == "__main__" :
	...
	features_to_analyze_path = '../possiblyImportantFeatures.csv'
	sys.exit( runFeatureReduce(drugIndex,features_to_analyze_path) )
